...
const addNewCustomer = async (req, res) => {
  const { name, email, phone_number, adresse } = req.body;
...
const updateCustomerById = async (req, res) => {
  const id = req.params.id;
  const { email, phone_number, adresse } = req.body;
...
module.exports = { getCustomers, getCustomerById, addNewCustomer, updateCustomerById, deleteCustomerById };